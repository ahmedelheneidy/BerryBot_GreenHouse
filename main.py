...
X = data[['Indoor Temperature', 'Indoor Humidity', 'Outdoor Temperature', 'Outdoor Humidity', 'Indoor Light Intensity', 'Outdoor Anemometer', 'Outdoor Light Intensity', 'Air Quality', 'Soil Moisture']]
